...
interface ContentFormProps {
  username: string;
  categories?: Array<{ id: string; name: string }>; // Categories from DB
}

export default function ContentForm({ username, categories = [] }: ContentFormProps) {
    ...
    <div className='min-h-screen bg-gray-50/30'>
      <div className='mx-auto max-w-4xl px-4 py-12'>
        ...
        <div className='mb-12 text-center'>
          <h1 className='text-3xl font-light text-gray-900 tracking-tight'>Create New Blog Post</h1>
          <p className='mt-3 text-gray-600 font-light'>Share your thoughts</p>
        </div>
